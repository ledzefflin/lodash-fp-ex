...
declare type Tternary = F.Curry<(<T>(evaluator: (arg: T) => boolean | unknown, trueHandler: (arg: T) => unknown, falseHandler: (arg: T) => unknown, arg: T) => unknown)>;
...
declare type TinstanceOf = F.Curry<(<T>(t: unknown, arg: T) => boolean)>;
...
declare type Tkey = F.Curry<(obj: Record<string, unknown>, value: unknown) => string>;
...
declare type Tap = F.Curry<(arg: unknown, curried: Function) => any>;
declare type TnotIncludes = F.Curry<(arg: unknown, targetArray: unknown[] | Record<string, unknown> | string) => boolean>;
